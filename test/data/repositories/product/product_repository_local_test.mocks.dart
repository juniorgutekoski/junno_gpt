...
// in junno_app/test/data/repositories/product/product_repository_local_test.dart.
...
import 'package:junno_app/src/data/services/local/product/product_service.dart'
    as _i2;
import 'package:junno_app/src/domain/models/product/product.dart' as _i4;
...
class MockProductService extends _i1.Mock implements _i2.ProductService {
  @override
  _i3.Future<int> createProduct(_i4.Product? product) => (super.noSuchMethod(
        Invocation.method(
          #createProduct,
          [product],
        ),
  ...
  @override
  _i3.Future<bool> deleteProduct(int? id) => (super.noSuchMethod(
        Invocation.method(
          #deleteProduct,
          [id],
        ),
